        ...
        <>
            <div className="home">
                ...
                <section className="about-company">
                    <h2>About Us</h2>
                    <p>
                        At Keystaxx, we believe that a great keyboard is not just about functionality; it’s about the experience. We craft keyboards that fit every need — from high-performance mechanical models for gamers and coders to comfortable, ergonomic options for everyday use. Our products combine precision engineering with customizable aesthetics, allowing you to express your style while enhancing your typing experience.
                    </p>
                    <p>
                ...
                <section className="what-we-offer">
                    ...
                    <ul>
                        ...
                        <li>
                            <strong>Customizable Options:</strong> Add your personal touch to your keyboard with a wide variety of colors, switches, and keycaps.
                        </li>
                        <li>
                ...
                <section className="call-to-action">
                    <h2>Ready to Find Your Perfect Keyboard?</h2>
                    <p>
